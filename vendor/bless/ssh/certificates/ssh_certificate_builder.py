...
critical_option_force_command: {critical_option_force_command}
critical_option_source_address: {critical_option_source_address}
...
class SSHCertificateBuilder(object):
    ...
    def __str__(self):
        return SSH_CERTIFICATE_STRING.format(
            ca=self.ca,
            nonce=self.nonce,
            public_key_comment=self.public_key_comment.rstrip(),
            serial=self.serial,
            ...
            critical_option_force_command=self.critical_option_force_command,
            critical_option_source_address=self.critical_option_source_address,
